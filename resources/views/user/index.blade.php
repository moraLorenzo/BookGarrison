...
<script src="https://icons.getbootstrap.com/icons/book/" crossorigin="anonymous"></script>
        ...
        <div class="col">
            ...
            <br>
                    ...
                    <form method="GET" action="{{ route('user.check_requested', ['id'=>$user->id]) }}" enctype="multipart/form-data">
                      @csrf
                      <button type="submit" class="btn col-12 btn-success font-weight-bold custom-box-shadow">Show Requested
                    ...
                    <table class="table table-striped bg-light custom-table custom-box" style="width: 100%">
                        <thead

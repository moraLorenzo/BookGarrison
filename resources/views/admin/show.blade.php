                    ...
                    <div class="card mx-auto" style="width: 24rem;">
                        ...
                        <div class="card-body">
                            ...
                            <form id="my_form" style="float: right;" action="{{ route('admin.destroy', $book->id) }}" method="POST">
                                ...
                                <a type="submit" class="text-danger" onclick="document.getElementById('my_form').submit();">Delete <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">

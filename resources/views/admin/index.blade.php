...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
              <a class="btn col-12 btn-add font-weight-bold custom-box-shadow" href="/book/create">Add More Books! <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
